...
const projects = [
  ...
  },
  {
    ...
    description: 'Custom inventory management system with barcode scanning feature developed using Visual Basic.',
    image: 'https://via.placeholder.com/600x400',
    tech: ['Visual Basic', 'Database', 'Barcode'],
    link: '#',
  },
  {
    title: 'Catering Website',
    description: 'Responsive catering website built with modern technologies for online orders and customer engagement.',
    image: 'https://via.placeholder.com/600x400',
